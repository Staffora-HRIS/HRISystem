...
-- Add FK from job_competencies.job_id -> jobs.id.
-- app.jobs is created by 0106_jobs.sql which runs just before this migration.
-- The constraint is added idempotently in case this migration is re-run.
DO $$ BEGIN
    IF NOT EXISTS (
