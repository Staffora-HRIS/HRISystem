-- Migration: 0094_seed_admin_user
-- Created: 2026-01-09
...
-- Hash generated with: bcryptjs.hashSync('CHANGE_ON_FIRST_LOGIN', 12)
INSERT INTO app.users (
    ...
    '$2b$12$OM38b4W.6.lbVelHfUiuruOneaQzTLSowP31b6aBNCTrQJRkXEmmi',
    false,
    'active',
    now(),
    now()
) ON CONFLICT (email) DO UPDATE SET
    password_hash = '$2b$12$OM38b4W.6.lbVelHfUiuruOneaQzTLSowP31b6aBNCTrQJRkXEmmi',
    status = 'active',
    updated_at = now();
...
BEGIN
    ...
    RAISE NOTICE 'Password: CHANGE_ON_FIRST_LOGIN';
