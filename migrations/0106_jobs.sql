...
-- DROP INDEX IF EXISTS app.idx_jobs_status;
-- DROP INDEX IF EXISTS app.idx_jobs_family;
-- DROP INDEX IF EXISTS app.idx_jobs_code;
-- DROP INDEX IF EXISTS app.idx_jobs_tenant;
