...
export const apiKeyRoutes = new Elysia({ prefix: "/api-keys", name: "api-keys-routes" })
  ...
  .get(
    ...
    },
    {
      ...
      query: t.Composite([
        t.Partial(ApiKeyFiltersSchema),
        t.Partial(PaginationQuerySchema),
      ]),
      response: t.Object({
        items: t.Array(ApiKeyResponseSchema),
      ...
      detail: {
        ...
        description: "List API keys for the current tenant. Shows key prefix only, never the full key.",
        security: [{ bearerAuth: [] }],
      },
    }
  )
      ...
      if (audit) {
        await audit.log({
          ...
          newValues: {
            ...
            // Intentionally do NOT log the full key in audit
          },
          metadata: { requestId },
        });
      }
  ...
  .get(
    ...
    },
    {
      ...
      detail: {
        ...
        description: "Get API key details. Shows key prefix only, never the full key.",
        security: [{ bearerAuth: [] }],
      },
    }
  )
  ...
  .patch(
    ...
    },
    {
      ...
      detail: {
        ...
        description: "Update an API key's name, scopes, or expiry. Cannot update a revoked key.",
        security: [{ bearerAuth: [] }],
      },
    }
  )
  ...
  .delete(
    ...
    },
    {
      ...
      detail: {
        ...
        description: "Revoke an API key. The key can no longer be used for authentication.",
        security: [{ bearerAuth: [] }],
      },
    }
  );
