...
export const CreateLeaveTypeSchema = t.Object({
  ...
  requiresDocumentation: t.Optional(t.Boolean({ default: false })),
  maxDaysPerRequest: t.Optional(t.Number({ minimum: 0.5, maximum: 365 })),
  minDaysNotice: t.Optional(t.Number({ minimum: 0, maximum: 365, default: 0 })),
...
export const LeaveTypeResponseSchema = t.Object({
  ...
  requiresDocumentation: t.Boolean(),
  maxDaysPerRequest: t.Nullable(t.Number()),
  minDaysNotice: t.Number(),
