...
**Evidence:** Grep for `data.?export`, `subject.?access`, `right.?to.?erasure`, `gdpr`, `anonymi[sz]e` found no implementation in the API modules. References exist only in audit documentation and the marketing website's privacy page.
