...
> Staffora HRIS Platform -- Common issues, debug procedures, and lessons learned from real debugging sessions.
>
> Issues documented here are extracted from `.claude/learning.md` where noted.
