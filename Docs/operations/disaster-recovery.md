...
- [Worker System](../architecture/WORKER_SYSTEM.md) -- Background job architecture
- [Database Guide](../architecture/database-guide.md) -- Schema, migrations, RLS details
- [Security Patterns](../patterns/SECURITY.md) -- RLS, auth, RBAC, audit, idempotency
