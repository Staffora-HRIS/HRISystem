...
Superseded or deprecated documentation kept for historical reference. Files here have been replaced by newer versions elsewhere in the docs.
...
These files are retained for historical context only. Do not use them as the source of truth for current project state. Refer to the active documentation directories for up-to-date information.
