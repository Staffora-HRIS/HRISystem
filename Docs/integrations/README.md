...
This document covers all external service integrations used by the Staffora platform, including configuration, environment variables, and usage patterns for each.
